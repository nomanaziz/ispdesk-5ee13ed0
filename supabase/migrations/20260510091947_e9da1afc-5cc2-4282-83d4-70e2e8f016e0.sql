...
BEGIN
  ...
  IF v_pkg.mikrotik_id IS NOT NULL THEN
    SELECT name INTO v_server_name FROM public.mikrotik_devices WHERE id = v_pkg.mikrotik_id;
  END IF;
  ...
  FOR i IN 0..(p_days - 1) LOOP
    ...
    INSERT INTO public.pop_daily_charges (
      ...
      v_client.package_id, v_pkg.name, v_pkg.mikrotik_profile, v_pkg.protocol,
      v_pkg.mikrotik_id, v_server_name, v_zone.id, v_zone.name, v_subzone.id, v_subzone.name,
