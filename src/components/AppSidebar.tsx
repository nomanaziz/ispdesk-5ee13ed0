...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "HR Settings", url: "/dashboard/hr/settings", icon: Settings },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { title: "প্যাকেজ", url: "/dashboard/branches/packages", icon: Package },
      ...
      { title: "রিসেলার ফান্ডিং", url: "/dashboard/branches/funding", icon: Banknote },
